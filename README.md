...
<ol>
    ...
    <li>
        <h3>HTTP request:</h3>
        <img src="./img/req-1.png" alt="req-1" width="450"> <img src="./img/req-1param.png" alt="req-1param" width="240"><br>
        I intercepted the request using burp and url-decoded the <code>url</code> parameter. So, we can see that it has <br>Internal Network Exposure(SSRF) vulnerability.<br>
