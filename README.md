...
<ol>
    ...
    <li>
        ...
        I was going through the page and found this. if there was anything on this page <br>that could help me, was this option. So i search "Export pdf vulnerability" and found <a href="https://inonst.medium.com/export-injection-2eebc4f17117">this</a>.<br>The first step was to capture and monitor the http request.
    </li><br>
    <li>
        <h3>HTTP request:</h3>
